...
export type ProjectAsset=Attachment&{kind:'photo'|'file'|'specification';source:'project'|'task';author:string;authorRole:Profession;creatorId:string;taskId?:string;sheetId?:string;liked:boolean;likeCount:number};
